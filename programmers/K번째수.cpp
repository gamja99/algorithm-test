...
나온 경과를 배열에 담아 return하도록 solution 함수를 작성해주세요.


#제한사항
1. array의 길이는 1 이상 100 이하 이다. 
2. array의 각 원소는 1 이상 100 이하 이다. 
3. commands의 길이는 1 이상 50 이하 이다. 
4. commands의 각 원소는 길이가 3 이다. 
